...
DETAIL_URL = "equipment-create-2nd"


class EquipmentCreate2Test(TestCase):
    def setUp(self) -> None:
        self.client = Client()
        self.fake = Faker()
    ...
    @staticmethod
    def detail_url(obj, name: str = "Spatula") -> str:
        return reverse(DETAIL_URL, kwargs={"container": obj.pk, "name": name})
